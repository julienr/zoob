...
//Implements David Silver "Cooperative Pathfinding - The problem with A*"
class PathFinder {
  public:
    ...
    struct StopCondition : public TemporalAStar::StopCondition {};
  ...
  public:
    ...
    Path* findPath (const Vector2& start, const Vector2& end, Entity* e, float entityMoveSpeed, StopCondition* cond=NULL);
